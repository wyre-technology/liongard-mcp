...
RUN addgroup -g 1001 -S liongard && \
    adduser -S liongard -u 1001 -G liongard
...
RUN mkdir -p /app/logs && chown -R liongard:liongard /app
...
LABEL org.opencontainers.image.title="liongard-mcp"
LABEL org.opencontainers.image.description="Model Context Protocol server for Liongard configuration management integration"
